...
const howToPlayPop = (
  <Popover id="popover-basic">
    <Popover.Header as="h3">Puzzle Instruction</Popover.Header>
    <Popover.Body>
...
const tipsPop = (
  <Popover id="popover-basic">
    <Popover.Header as="h3">Puzzle Tips</Popover.Header>
    <Popover.Body>
      <ol>
        <li>
      ...
      <strong>Enjoy playing Puzzle!</strong>
    </Popover.Body>
  </Popover>
);
    ...
    <>
      <div className={styles["game-container"]}>
        <div className={styles["game-internal-container"]}>
          <div className={styles["puzzle-actions"]}>
            <div>
          ...
          <div className={styles["puzzle-board-container"]}>
            <div className={styles["puzzle-board"]}>
              <div className={styles["grid-cells"]}>Puzzle board</div>
            </div>
          </div>
          <div className={styles["puzzle-game-info"]}>
            <Box
              sx={{
